...
class Application():
  ...
  def bbswitch_enabled(self):
      bbswitch_file = "/proc/acpi/bbswitch"
      if os.path.isfile(bbswitch_file):
          return True
      else:
          return False
  ...
  def show_drivers(self):
    ...
    for device in sorted(self.devices):
      ...
      if device == "bumblebee_device":
          ...
          overall_status = _("We detected you have an Optimus notebook, bumblebee-nvidia will be installed with nvidia-driver.")
